...
Coordinates prompt formatting, state extraction, crisis prevention, and response generation
through the pluggable CustomAIModel.
"""
...
class AIEngine:
    ...
    Exposes unified generation, streaming, and state tracking methods.
    """
    ...
    def update_model(self, custom_model_instance: Any):
        """Allows dynamically swapping the underlying model instance at runtime."""
    ...
    def analyze_user_input(self, user_text: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        Extracts emotional signals, distress metrics, and risk assessment from user message.
        """
    ...
    async def generate_response(
        ...
        **kwargs
        ...
        """
        Generates a full text response for the user.
        """
