...
Provides a fast, zero-dependency offline model with emotional intelligence heuristics,
sentiment classification, and context-aware responses.
Useful for testing, development, and when no external model or GPU is loaded.
"""
import asyncio
...
class MockAIModel(BaseAIModel):
    ...
    def analyze_state(self, text: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """Classify emotional state and safety risk using heuristic rules."""
    ...
    def generate(
        ...
        **kwargs
        ...
        """Generate a response using conversational templates."""
